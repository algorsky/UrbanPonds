...
epcRAW<-read.csv("EPC_22_clean.csv")
View(epcRAW)
...
Cl_0_EPC #y=-0.803+4.523X
# Calculate x-intercept: 0.177537 mg/L
0.803/4.523
abline(h=0,v=0.04587427,lwd=2,col="grey40")
...
Cl_50_EPC #y=-0.8082+4.6658x
# Calculate x-intercept: 0.1732179 mg/L
0.8082/4.6658
abline(h=0,v=0.06962893,lwd=2,col="grey40")
...
Cl_100_EPC #y=-0.845 + 4.790 x
# Calculate x-intercept: 0.1764092mg/L
0.845 / 4.790 
abline(h=0,v=0.1177267,lwd=2,col="grey40")
