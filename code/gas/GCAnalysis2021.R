...
df.2021 = read_csv('data/gas/df.2021.csv')
...
#write.table(dat.2021, 'data/gas/dat_summer21_01.csv', sep="\t")

dat = read_csv('data/gas/dat_summer21_01.csv')
...
#write.table(tidy.dat.out.summer2021, 'data/gas/tidy.summer21_01.csv', sep="\t")
